...
% 28.08.2014
  ...
  for indx = 1:nchannels
    ...
    % Filter them
    mytracking.trackings(indx).detections = filter_tracking(mytracking.trackings(indx).detections, opts.tracks_filtering.min_tips_length, opts.tracks_filtering.min_path_length, opts.tracks_filtering.max_zip_length,opts.tracks_filtering.interpolate);
