...
% 02.07.2014
  ...
  % and linking the calbacks.
    ...
    handles = struct('uipanel', hPanel, ...
                     ...
                     'experiment', hName, ...
                     'all_buttons', enabled, ...
                     'pipeline', [hSegment, hTrack, hPaths], ...
                     'auto', hAutosave, ...
