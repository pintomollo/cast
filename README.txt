...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 - The various filters available are listed on the right of the image panels:
   ...
   - Hot pixels   : Removes hot-pixels generated by the camera sensor
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 - To tune the filtering of the sample data, let's set "cosmic_rays_threshold" to 30.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 - If you are segmenting the sample data, the detection algorithm should be a bit too
   ...
   - Remove tiny cells      : Increase "filter_min_size" to 3
