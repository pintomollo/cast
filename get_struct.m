...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    case 'fitting'
      mystruct = struct('type', 'simul', ...
                        ...
                        'sample_log', true, ...
                        'integrate_sigma', true, ...
                        'combine_data', 'together', ...
                        'offset_scaling', 1, ...
                        'fit_relative', false, ...
                        'fixed_parameter', [], ...
                        'rescale_length_only', false, ...
                        'fitting_type', 'optimization', ...
                        'parameter_set', 2, ...
                        'scale_type', 'normalize', ...
                        'normalize_smooth', true, ...
                        'step_size', 0.05, ...
                        'ground_truth', [], ...
                        'max_population', 50, ...
                        'x_pos', [], ...
